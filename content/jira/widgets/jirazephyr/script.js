...
function run (){
    var data = {};
    var jsonResponse = Packages.call("https://jira.com/jra/rest/zephyr/1.0/util/project-list", "Authorization", "Basic "+Packages.btoa(WIDGET_CONFIG_JIRA_USER+":"+WIDGET_CONFIG_JIRA_PASSWORD), null);
    ...
    // Find version id
    jsonResponse = Packages.call("https://jira.com/jra/rest/zephyr/1.0/util/versionBoard-list?projectId="+projectId, "Authorization", "Basic "+Packages.btoa(WIDGET_CONFIG_JIRA_USER+":"+WIDGET_CONFIG_JIRA_PASSWORD), null);
    ...
    // Get cycle
    jsonResponse = Packages.call("https://jira.com/jra/rest/zephyr/1.0/cycle/?projectId="+projectId+"&versionId="+versionId+"&expand=executionSummaries", "Authorization", "Basic "+Packages.btoa(WIDGET_CONFIG_JIRA_USER+":"+WIDGET_CONFIG_JIRA_PASSWORD), null);
    jsonObject = JSON.parse(jsonResponse);
