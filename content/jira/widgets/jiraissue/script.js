...
function run (){
    // previous data
    var data = {};
    var jsonResponse = Packages.call("https://jira.com/jra/rest/api/2/search?jql="+encodeURIComponent(SURI_JQL)+"&maxResults="+SURI_NUMBER+"&fields=summary,status", "Authorization", "Basic "+Packages.btoa(WIDGET_CONFIG_JIRA_USER+":"+WIDGET_CONFIG_JIRA_PASSWORD), null);
