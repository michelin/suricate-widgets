...
function run (){
    ...
    var jsonResponse = Packages.call("https://jira.com/jra/rest/api/2/search?jql="+encodeURIComponent(SURI_JQL)+"&maxResults=0", "Authorization", "Basic "+Packages.btoa(WIDGET_CONFIG_JIRA_USER+":"+WIDGET_CONFIG_JIRA_PASSWORD), null);
